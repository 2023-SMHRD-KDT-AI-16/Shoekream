        ...
        <div class="content">
            <div class="grid-container">
                ...
                <%for(int i =0;i<post_list.size();i++){ %>
                 <div class="my_post<%=i%>"><img src="post_img/<%= post_list.get(i).getPostImg() %>" alt="사진"></div>
                 <%} %>
