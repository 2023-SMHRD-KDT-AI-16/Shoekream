                                                ...
                                                <div class="row align-items-center gx-4">
                                                    <div class="col-auto">
                                                        <div class="avatar avatar-xs">
                                                            <img class="avatar-img" src="assets/img/avatars/bootstrap.svg" alt="ShoeKream Community">
                                                        </div>
                                                    </div>

                                                    <div class="col">
                                                        <h6 class="mb-0">ShoeKream Community</h6>
                                                    </div>
                                        ...
                                        <div class="col-12 col-xl-6">
                                            <div class="row align-items-center gx-5">
                                                ...
                                                <div class="col overflow-hidden">
                                                    <h5 class="text-truncate">ShoeKream Community</h5>
